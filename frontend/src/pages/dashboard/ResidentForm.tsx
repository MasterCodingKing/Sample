      ...
      try {
        ...
        if (id) {
          ...
          reset({
            ...
            birthdate: resident.birthdate?.split('T')[0] || resident.date_of_birth?.split('T')[0],
            birthplace: resident.birthplace || resident.place_of_birth || '',
            ...
            purok: resident.purok || resident.zone_purok || '',
            household_id: resident.household_id || undefined,
            occupation: resident.occupation || '',
            monthly_income: resident.monthly_income || undefined,
            education: resident.education || resident.education_level || '',
            is_voter: resident.is_voter ?? resident.voter_status ?? false,
            is_4ps_member: resident.is_4ps_member || false,
            is_pwd: resident.is_pwd || false,
            is_senior: resident.is_senior ?? resident.is_senior_citizen ?? false,
